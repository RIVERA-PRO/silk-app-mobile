...
export default function FormPublicacion() {
    ...
    const handleSubmit = async () => {
        ...
        const url = 'https://silk.onrender.com/historias';
        ...
        <View style={styles.modalContainer}>
            ...
            <View style={styles.header}>
                ...
                >
                    ...
                    {isLoading ? <ActivityIndicator style={styles.loader} size="large" color="#000" /> : <Text style={styles.titleHeader}>Crear Historia</Text>}
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.formModal}>
                <TextInput
                    placeholder="Descripcion de tu historia"
